...
async def verify_stripe_integration():
    ...
    async with AsyncSessionLocal() as db:
        ...
        session = stripe_identity_service.create_verification_session(str(user_id), user.email)
        ...
        print("   📩 Simulating Webhook Event 'identity.verification_session.verified'...")
