...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "session_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("property_media_sessions.id"),
            nullable=True,
        ),
        ...
        sa.Column(
            "captured_latitude", sa.DECIMAL(precision=10, scale=8), nullable=True
        ),
        sa.Column(
            "captured_longitude", sa.DECIMAL(precision=11, scale=8), nullable=True
        ),
        sa.Column(
            "distance_from_target", sa.DECIMAL(precision=8, scale=2), nullable=True
        ),
