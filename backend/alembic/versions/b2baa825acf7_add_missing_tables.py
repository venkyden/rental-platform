...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'property_media_sessions', type_='foreignkey')
    ...
    op.drop_constraint(None, 'property_media', type_='foreignkey')
    ...
    op.drop_constraint(None, 'onboarding_responses', type_='unique')
