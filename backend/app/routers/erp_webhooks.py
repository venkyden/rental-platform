...
async def list_subscriptions(
    ...
    if current_user.role not in [UserRole.LANDLORD, UserRole.PROPERTY_MANAGER]:
        raise HTTPException(status_code=403, detail="Only landlords can manage webhooks")
...
async def create_subscription(
    ...
    if current_user.role not in [UserRole.LANDLORD, UserRole.PROPERTY_MANAGER]:
        raise HTTPException(status_code=403, detail="Only landlords can create webhooks")
