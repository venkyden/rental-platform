    ...
    def decorator(func: Callable):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if not cb._should_allow_request():
                ...
                raise CircuitBreakerError(f"Circuit '{name}' is OPEN. Service unavailable.")
...
def resilient(
    ...
    def decorator(func: Callable):
        ...
        protected = circuit_breaker(name=name, failure_threshold=failure_threshold, fallback=fallback)(retried)
        return protected
    return decorator
