...
async def geocode_address(address: str, city: str, postal_code: str, country: str = "France") -> Optional[Tuple[float, float]]:
    """
...
def parse_overpass_results(data: Dict, origin_lat: float, origin_lon: float) -> Dict[str, List[Dict]]:
    ...
    return {
        "public_transport": transport_list,
        "nearby_landmarks": landmark_list
    }


async def enrich_property_location(address: str, city: str, postal_code: str, country: str = "France") -> Dict:
    """
