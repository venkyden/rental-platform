from sqlalchemy import Column, String, Boolean, Integer, DateTime, JSON, Enum as SQLEnum, TIMESTAMP, ForeignKey
...
class User(Base):
    ...
    identity_data = Column(JSON, nullable=True)  # Stores eIDV results, trust score, etc.
    employment_data = Column(JSON, nullable=True)  # Stores employment verification results
...
class VerificationRecord(Base):
    ...
    # Verification type
    verification_type = Column(String, nullable=False)  # passive_eidv, document, liveness, employment
