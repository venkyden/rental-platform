...
Status: ✅ Owner risk-accepted (2026-07-15) — transcription verified 99.30% against the
...
a) Montant du loyer mensuel : {{loyer_mensuel}} (7) ;
...
Le cas échéant, Montant du dépôt de garantie de l'exécution des obligations du locataire / Garantie autonome : {{depot_garantie}}.
