...
test.describe('Landing Page E2E Tests', () => {
    ...
    test('featured listings section renders', async ({ page }) => {
        ...
        await expect(page.getByText('Haussmannian apartments, studios and flatshares')).toBeVisible();
        await expect(page.getByText('Lofts and apartments from PresquՔle to Part-Dieu')).toBeVisible();
    });
