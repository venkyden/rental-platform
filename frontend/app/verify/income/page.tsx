        ...
        <ProtectedRoute>
            <PremiumLayout withNavbar={false}>
                ...
                <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-slate-50">
                    ...
                    >
                        <div className="glass-card !p-12 sm:!p-16 rounded-[3.5rem] shadow-[0_60px_120px_-20px_rgba(0,0,0,0.15)] border-zinc-100 relative overflow-hidden">
                            ...
                            <div className="mb-16 text-center space-y-4">
                                ...
                                <h1 className="text-4xl sm:text-5xl font-black tracking-tighter uppercase leading-none">
                                    {t('verify.income.title', undefined, 'Income Verification')}
                                </h1>
                                <p className="text-lg text-zinc-500 font-medium max-w-sm mx-auto">
                                    {t('verify.income.description', undefined, 'To comply with French rental standards, please verify your resources.')}
                                </p>
                            </div>
