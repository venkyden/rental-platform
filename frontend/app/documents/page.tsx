                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <motion.div 
                            ...
                            className="glass-card !p-12 sm:!p-16 rounded-[3rem] border-zinc-100 relative overflow-hidden shadow-2xl"
                        >
                            ...
                            <div className="flex items-center gap-6 mb-12">
                                <div className="w-20 h-20 bg-zinc-900/5 rounded-[2rem] flex items-center justify-center shadow-inner">
                            ...
                            <button
                                ...
                                className="w-full py-6 bg-zinc-900 text-white rounded-[2rem] text-sm font-black uppercase tracking-[0.4em] hover:scale-[1.02] active:scale-95 transition-all shadow-2xl"
                            >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            {[
                                { title: 'Identity', icon: Shield, color: 'text-zinc-900', bg: 'bg-zinc-900/5', count: 0 },
                                { title: 'Income', icon: FileText, color: 'text-zinc-900', bg: 'bg-zinc-900/5', count: 0 },
                                { title: 'Receipts', icon: Lock, color: 'text-zinc-900', bg: 'bg-zinc-900/5', count: 0 },
                                { title: 'Guarantor', icon: Shield, color: 'text-zinc-900', bg: 'bg-zinc-900/5', count: 0 }
                            ].map((doc, idx) => (
                                <motion.div 
                                    key={idx}
                                    ...
                                    className="glass-card !p-10 rounded-[2.5rem] border-zinc-100 hover:shadow-xl transition-all group"
                                >
