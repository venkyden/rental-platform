            ...
            <ProtectedRoute>
                <PremiumLayout withNavbar={true}>
                    <div className="flex items-center justify-center min-h-[60vh]">
                        <div className="animate-spin rounded-full h-16 w-16 border-b-4 border-teal-500" />
                    </div>
                </PremiumLayout>
            </ProtectedRoute>
        );
                                        ...
                                        <div className="space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-transparent text-4xl font-black tracking-tighter text-zinc-900 dark:text-white border-none focus:ring-0"
                                                />
                                            </div>
                                            <div className="space-y-6">
                        ...
                        <div className="lg:col-span-5">
                            <div className="sticky top-32 glass-card !p-12 rounded-[4rem] border-zinc-100 dark:border-zinc-800/50 bg-zinc-50/50 dark:bg-zinc-900/50">
                                <div className="mb-12">
                                    ...
                                    <h4 className="text-xl font-black uppercase tracking-tighter mb-4 italic text-zinc-900 dark:text-white">Registry Management</h4>
