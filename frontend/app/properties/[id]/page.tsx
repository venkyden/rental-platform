...
import { MapPin, Share2, Shield, Zap, Wind, Check, LayoutGrid, Info, Sparkles, TrendingUp } from 'lucide-react';
...
export default function PropertyDetailPage() {
    ...
    const matchScore = user?.role === 'tenant' ? (Math.floor(Math.random() * 20) + 80) : null;
    const matchReasons = [
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            <div className="lg:col-span-8 space-y-12">
                                ...
                                <motion.div 
                                    ...
                                    viewport={{ once: true }}
                                    className="glass-card !p-0 rounded-[3.5rem] shadow-[0_60px_120px_-20px_rgba(0,0,0,0.15)]_60px_120px_-20px_rgba(0,0,0,0.5)] border-zinc-100 overflow-hidden group"
                                >
                                ...
                                {/* Energy & Compliance */}
                                <div className="glass-card !p-12 rounded-[3rem] border-zinc-100 relative overflow-hidden">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                                        <div className="flex items-center gap-8">
                                            <div className={`w-24 h-24 rounded-3xl flex items-center justify-center text-3xl font-black text-white shadow-2xl relative ${
                                                property.dpe_rating === 'A' ? 'bg-zinc-900 shadow-zinc-900/20' : 
                                                property.dpe_rating === 'B' ? 'bg-zinc-800 shadow-zinc-900/20' : 
                                                ...
                                                <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-white rounded-full border border-zinc-100 flex items-center justify-center shadow-lg">
                                                    <Shield className={`w-4 h-4 ${property.dpe_rating === 'A' || property.dpe_rating === 'B' ? 'text-zinc-900' : 'text-zinc-400'}`} />
                                                </div>
                                            </div>
                                            <div>
                                ...
                                >
                                    ...
                                    {!isOwner ? (
                                        <div className="space-y-4">
                                            ...
                                            <button className="w-full py-6 bg-zinc-100 text-zinc-900 text-xs font-black uppercase tracking-[0.4em] rounded-[2rem] hover:bg-zinc-200 transition-all">
