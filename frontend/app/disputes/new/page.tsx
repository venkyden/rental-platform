...
export default function NewDisputePage() {
    ...
    return (
        <ProtectedRoute>
            <div className="min-h-screen bg-zinc-50 py-8 px-4 sm:px-6 lg:px-8 text-zinc-900">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-zinc-200 overflow-hidden">
                        <div className="px-6 py-8 border-b border-zinc-200 bg-zinc-50">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                {loadingLeases ? (
                                    <div className="h-10 bg-zinc-100 rounded animate-pulse w-full"></div>
                                ) : leases.length === 0 ? (
                                    <div className="p-4 bg-zinc-50 text-zinc-900 rounded-xl text-sm border border-zinc-200">
                                    ...
                                    <select
                                        ...
                                        required
                                        className="w-full rounded-xl border border-zinc-300 bg-white px-4 py-2 text-sm focus:border-zinc-900 focus:ring-zinc-900 outline-none"
                                    >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    required
                                    className="w-full rounded-xl border border-zinc-300 bg-white px-4 py-2 text-sm focus:border-red-500 focus:ring-red-500 outline-none"
                                >
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full rounded-xl border border-zinc-300 bg-white px-4 py-2 text-sm focus:border-zinc-900 focus:ring-zinc-900 outline-none resize-none"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-zinc-300 rounded-xl cursor-pointer hover:bg-zinc-50 transition-colors">
                                ...
                                {files.length > 0 && (
                                    <ul className="mt-4 space-y-2">
                                        {files.map((file, index) => (
                                            <li key={index} className="flex items-center justify-between p-3 bg-zinc-50 rounded-lg border border-zinc-200">
                                                <span className="text-sm truncate text-zinc-700">
                                                    {file.name}
                                                </span>
                                                <button 
                                                    type="button" 
                            ...
                            <div className="pt-4 border-t border-zinc-200">
                                <button
                                    ...
                                    className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-zinc-900 hover:bg-zinc-800 focus:outline-none focus:ring-4 focus:ring-zinc-900/20 disabled:opacity-50 transition-colors"
                                >
                                    {submitting ? (
                                        <>
