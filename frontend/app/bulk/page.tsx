        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-50">
            ...
            <div className="z-10 max-w-md w-full bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.1)] border border-white/50 p-8 text-center">
                ...
                <p className="text-zinc-500 mb-8">
                    ...
                    <br />
                    <span className="text-sm px-3 py-1 bg-zinc-900 text-white border border-zinc-900 rounded-full mt-2 inline-block font-medium">
                        Enterprise Feature (S3)
                    </span>
                </p>
                <div className="space-y-3">
                    <button
                        className="w-full py-3 text-sm font-bold text-white rounded-xl shadow-md transition-all hover:shadow-sm active:scale-[0.98] bg-zinc-900 hover:bg-zinc-800"
                    >
