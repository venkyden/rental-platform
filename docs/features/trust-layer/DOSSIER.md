...
Last updated: 2026-06-15. Status: **Phase 1 complete** — all 6 Phase-1 items shipped; Phase 2 MRH/DPE/guarantor also shipped; Item 12 (statelessness retrofit + Redis TTL) landed 2026-06-15. Open: Phase 2 items 8/9 (legal gate), 11 (CSCA); INTL solvency FX; zone-tendue advisory (PR #3 open).
